...
export default function (props) {
    ...
    // const [enterText, changeText] = useState("this is default text in my textBox");
    ...
    return (
        <div style={{backgroundColor:props.mode==='light'?'white':'black',color:props.mode==='light'?'black':'white'}}>
            ...
            <button className="btn btn-primary mx-3 my-2" onClick={maketoUppercase}>Convert to Uppercase</button>
            <button className="btn btn-primary mx-3 my-2" onClick={makeLowerCase}>makeLowwerCase</button>
            <button className="btn btn-primary mx-3 my-2" onClick={handleClearText}>ClearAll</button>
            <button className="btn btn-primary mx-3 my-2" onClick={handleCopy}>Copy Text</button>
            <button className="btn btn-primary mx-3" onClick={capitalFirstLetter}>Make 1st Char Capital</button>
            <button className="btn btn-primary mx-3 my-2" onClick={handleTrim}>trimming</button>
            <button className="btn btn-primary mx-3 my-2" onClick={handleExtrapace}>removeExtrapace</button>
            <button className="btn btn-primary mx-3 my-2" onClick={speak}>Text-Read</button>

            <div className="container">
                <h2>Your Text Summary</h2>
                <p><button className="btn btn-success mx-3 my-2" onClick={countWords}>Cal word</button>number of words {myCountWords}</p>
                <p><button className="btn btn-success mx-3 my-2" onClick={countChar}>Cal char</button>number of charector {myCharLen}</p>
                <p><button className="btn btn-success mx-3 my-2" onClick={timeRequireToRead}>TIme2Read</button>Time require to read this text {time} min</p>
                <h4>Preview</h4>
